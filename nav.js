...
// Real, deliberate tool-to-tool relationships for the "related tools"
// suggestion box shown at the bottom of every tool page. Built by
// reasoning about genuine real-world workflows (what someone using tool
// X would plausibly want to do next, or need to have done first) - not
// just "same category", which would produce weak, unhelpful pairings
// (e.g. Age Calculator and BMI Calculator share a category but a real
// user of one has no obvious reason to want the other; this mapping
// pairs by real usage relationships instead, checked by hand for each
// of the 56 real tools rather than generated by a blanket rule).
// Generated here, once, from nav.js's own real TOOLS data, matching
// this site's existing pattern (tool counts, the admin generator) of
// deriving everything from one real source of truth rather than
// hand-writing 56 separate, driftable HTML blocks.
const RELATED_TOOLS_MAP = {
  pdfedit: ['merge', 'compress', 'pdf2word'],
  merge: ['compress', 'split', 'pdf2word'],
  compress: ['merge', 'pdf2img', 'doc-scan'],
  split: ['merge', 'pdf2img'],
  pdf2img: ['img2pdf', 'compress'],
  img2pdf: ['jpg2pdf', 'merge', 'doc-scan'],
  jpg2pdf: ['img2pdf', 'merge'],
  pdf2word: ['word2pdf', 'pdf2text', 'text2doc'],
  word2pdf: ['pdf2word', 'compress'],
  pdf2text: ['pdf2word', 'img2text'],
  pdf2excel: ['pdf2word', 'json2csv'],
  pdf2ppt: ['pdf2word', 'compress'],
  pdf2md: ['md2html', 'md2pdf'],
  md2html: ['md2pdf', 'pdf2md'],
  md2pdf: ['md2html', 'pdf2word'],
  img2text: ['text2doc', 'doc-scan', 'pdf-ocr'],
  'pdf-ocr': ['pdf2text', 'img2text'],
  'doc-scan': ['img2text', 'compress', 'pdf2word'],
  text2doc: ['img2text', 'pdf2word'],
  'img-compress': ['bg-remove', 'img-resize', 'img2pdf'],
  'bg-remove': ['passport-photo', 'img-compress'],
  'passport-photo': ['bg-remove', 'img-crop', 'img-resize'],
  'img-resize': ['img-crop', 'img-compress'],
  'img-crop': ['img-resize', 'bg-remove'],
  exif: ['img-compress', 'img-resize'],
  svg2png: ['png2webp', 'img-resize'],
  heic2jpg: ['heic2png', 'img-compress'],
  heic2png: ['heic2jpg', 'img-compress'],
  jpg2webp: ['png2webp', 'webp2jpg'],
  png2webp: ['jpg2webp', 'webp2jpg'],
  webp2jpg: ['jpg2webp', 'png2webp'],
  'audio-conv': ['audio-compress', 'audio-trim'],
  'audio-trim': ['audio-conv', 'audio-compress'],
  'audio-compress': ['audio-conv', 'audio-trim'],
  'video-conv': ['video-compress', 'video-trim'],
  'video-compress': ['video-conv', 'video-trim'],
  video2mp3: ['audio-conv', 'video-trim'],
  video2gif: ['video-trim', 'video-compress'],
  'video-resize': ['video-compress', 'video-trim'],
  'video-trim': ['video-compress', 'video2gif'],
  'json-format': ['json2csv', 'xml2json'],
  json2csv: ['json-format', 'xml2json'],
  xml2json: ['json-format', 'json2csv'],
  base64: ['json-format', 'regex'],
  regex: ['json-format', 'base64'],
  color: ['svg2png', 'img-resize'],
  timestamp: ['date-calc', 'json-format'],
  'url-short': ['qr', 'json-format'],
  qr: ['url-short', 'img-resize'],
  'pct-calc': ['emi-calc', 'unit-conv'],
  'age-calc': ['date-calc', 'bmi-calc'],
  'bmi-calc': ['age-calc', 'unit-conv'],
  'unit-conv': ['currency-conv', 'pct-calc'],
  'currency-conv': ['unit-conv', 'emi-calc'],
  'emi-calc': ['currency-conv', 'pct-calc'],
  'date-calc': ['age-calc', 'timestamp'],
};

// Real, short, natural-sounding question phrased per real destination
// tool, used as the section's opening line - many are shared across
// several source tools where the same natural framing genuinely applies.
const RELATED_TOOLS_QUESTION = {
